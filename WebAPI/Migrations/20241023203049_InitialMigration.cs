            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreateDate = table.Column<DateTimeOffset>(type: "DATETIME(3)", nullable: false),
                    DueDate = table.Column<DateTimeOffset>(type: "DATETIME(3)", nullable: false),
                    CompletionDate = table.Column<DateTimeOffset>(type: "DATETIME(3)", nullable: true),
